...
## Admin Permissions Smoke (2026-02-07)
- Script: backend/scripts/admin-permission-smoke.js
- Log: logs/admin-permissions-smoke-2026-02-07.log
- Result: PASS (all expected role-based write checks + audit entries recorded using RUN_ID perm_smoke_20260207)
